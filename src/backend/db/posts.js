...
export const posts = [
  ...
  // Oliver Queen's posts
  {
    ...
    mediaURL:
      "https://res.cloudinary.com/ddaygqgu3/image/upload/v1711750834/am8eprfapm55srblioua.png",
    likes: {
      likeCount: 60,
      likedBy: [
        {
  ...
  },
  {
    ...
    mediaURL:
      "https://res.cloudinary.com/ddaygqgu3/image/upload/v1711750834/dfh4d1hg1wtvshn4xjbf.png",
    likes: {
      likeCount: 45,
      likedBy: [
        {
...

  {
    ...
    mediaURL:
      "https://res.cloudinary.com/ddaygqgu3/image/upload/v1711750858/wu8po90uiufix6qsd6zx.jpg",
    likes: {
      likeCount: 55,
      likedBy: [
        {
